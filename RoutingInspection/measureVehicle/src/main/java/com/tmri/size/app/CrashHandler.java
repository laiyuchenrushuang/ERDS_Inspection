...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    private final String LOG_PATH="/_Logs/WaiKuo/";
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                Toast.makeText(mContext, "很抱歉,程序出现异常,正在收集日志，即将退出", Toast.LENGTH_SHORT)
                        .show();
                Looper.loop();
            }
        }.start();
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(
                ...
                File dir = new File(Environment.getExternalStorageDirectory().toString(),LOG_PATH);
                if (!dir.exists()) {
                    dir.mkdirs();
                }
