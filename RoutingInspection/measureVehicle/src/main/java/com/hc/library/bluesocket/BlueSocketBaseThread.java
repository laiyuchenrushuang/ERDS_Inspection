...
public abstract class BlueSocketBaseThread extends Thread {
    ...
    public static final UUID UUID_ANDROID_DEVICE = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
//    public static final UUID UUID_ANDROID_DEVICE = UUID.fromString("00001101-0000-1000-8000-00805F9B34FB");
//    public static final UUID UUID_ANDROID_DEVICE = UUID.fromString("29913A2D-EB93-40cf-BBB8-DEEE26452197");
