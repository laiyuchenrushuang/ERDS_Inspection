...
import com.seatrend.http_sdk.base.BaseEntity;
import com.seatrend.http_sdk.base.ConmmonResponse;
import com.seatrend.http_sdk.base.GsonUtils;
import com.seatrend.http_sdk.inter.IRoutingService;
import com.seatrend.http_sdk.inter.base.BaseService;
import com.seatrend.http_sdk.interceptor.TokenInterceptor;
import okhttp3.*;
...
//==========================================================文件上传<start>===========================================================================
    ...
    public <T> void postMapFiles(final String baseurl, final String url, List<String> fileList, Class<T> service, boolean tolkened, final NormalView normalView) {
        ...
        for (String db : fileList) {
            params.put(db, RequestBody.create(new File(db), MediaType.parse("multipart/form-data")));
        }
